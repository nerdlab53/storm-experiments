'''
Implementation taken from : https://github.com/nuwuxian/RL-state_mask/blob/main/normal_form/Cartpole/ppo_lasso.py
'''
import os
import numpy as np
import torch as T
...
class Masknet:
    ...
    def learn(self, num_mask):
        loss_buff = []
        # Fallback discriminator score to avoid NameError in LAMBDA update
        disc_score = [0.0]
        for _ in range(self.n_epochs):
            ...
            # Update LAMBDA; disc_score not tracked in this implementation, default to zero
